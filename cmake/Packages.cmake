...
#		set(OPENESL_FEATURE_PATH "${CMAKE_BINARY_DIR}/external/gnutls-3.7.5")
...
#					INCLUDES DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}
		...
		elseif(UNIX OR APPLE)
			...
			if("GnuTLS" IN_LIST OPENESL_USE_SYSTEM_LIBS)
				...
				message(STATUS "**********************************")
				message(STATUS "*** Provide GnuTLS for OpenESL ***")
				message(STATUS "**********************************")
				if(OPENESL_USE_OFFLINE_LIBS)
...
#					INCLUDES DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}
				...
				message(STATUS "*****************************************")
				message(STATUS "*** Provide libmicrohttpd for OpenESL ***")
				message(STATUS "*****************************************")
